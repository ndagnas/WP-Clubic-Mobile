		...
		internal ApplicationInfosEventArgs ( XElement StoreContent, CultureInfo CultureInfo )
			...
			try
				...
				if ( XEntry != null )
					...
					if ( XIsAvailableInCountry   != null ) this.IsAvailableInCountry   = XIsAvailableInCountry  .Value.IsTrue ();
					if ( XIsAvailableInStore     != null ) this.IsAvailableInStore     = XIsAvailableInStore    .Value.IsTrue ();
					if ( XIsBlacklisted          != null ) this.IsBlacklisted          = XIsBlacklisted         .Value.IsTrue ();
					if ( XIsClientTypeCompatible != null ) this.IsClientTypeCompatible = XIsClientTypeCompatible.Value.IsTrue ();
					if ( XIsHardwareCompatible   != null ) this.IsHardwareCompatible   = XIsHardwareCompatible  .Value.IsTrue ();
					//-----------------------------------------------------------------------------------------------------------
