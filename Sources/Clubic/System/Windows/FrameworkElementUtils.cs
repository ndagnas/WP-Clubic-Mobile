...
namespace System.Windows
	...
	public static class FrameworkElementUtils
		...
		//-----------------------------------------------------------------------------------------------------------------------
		public static void Animate ( this DependencyObject Self, double From, double To, object PropertyPath, int Duration, 
		                                                  int StartTime, IEasingFunction Easing = null, Action Completed = null )
			{
			//-------------------------------------------------------------------------------------------------------------------
		...
		public static void Capture ( this FrameworkElement Self )
			...
			string FileName = System.IO.Path.GetExtension 
				                            ( Self.GetType ().ToString () ).Replace ( ".", "" );
