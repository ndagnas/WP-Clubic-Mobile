...
namespace System.Windows.Phone.Controls
	...
	public class CustomMessageBox : ContentControl
		...
		private static readonly double ScreenWidth     = Application.Current.Host.Content.
		                                                                              ActualWidth;
		private static readonly double ScreenHeight    = Application.Current.Host.Content.
		                                                                              ActualHeight;
		...
		/// <param name="Args">The event information.</param>
		//-----------------------------------------------------------------------------------------------------------------------
		private static void OnIsFullScreenPropertyChanged ( DependencyObject Sender, 
		                                                  DependencyPropertyChangedEventArgs Args )
			{
			//-------------------------------------------------------------------------------------------------------------------
			CustomMessageBox Target = (CustomMessageBox)Sender;
		...
		/// <param name="Args">The event information.</param>
		//-----------------------------------------------------------------------------------------------------------------------
		private static void OnLeftButtonContentPropertyChanged ( DependencyObject Sender, 
		                                                  DependencyPropertyChangedEventArgs Args )
			{
			//-------------------------------------------------------------------------------------------------------------------
			CustomMessageBox Target = (CustomMessageBox)Sender;
		...
		/// <param name="Args">The event information.</param>
		//-----------------------------------------------------------------------------------------------------------------------
		private static void OnMessagePropertyChanged ( DependencyObject Sender, 
		                                                  DependencyPropertyChangedEventArgs Args )
			{
			//-------------------------------------------------------------------------------------------------------------------
			CustomMessageBox Target = (CustomMessageBox)Sender;
		...
		/// <param name="Args">The event information.</param>
		//-----------------------------------------------------------------------------------------------------------------------
		private static void OnRightButtonContentPropertyChanged ( DependencyObject Sender, 
		                                                  DependencyPropertyChangedEventArgs Args )
			{
			//-------------------------------------------------------------------------------------------------------------------
			CustomMessageBox Target = (CustomMessageBox)Sender;
		...
		/// <param name="Args">The event information.</param>
		//-----------------------------------------------------------------------------------------------------------------------
		private static void OnTitlePropertyChanged ( DependencyObject Sender, 
		                                                  DependencyPropertyChangedEventArgs Args )
			{
			//-------------------------------------------------------------------------------------------------------------------
			CustomMessageBox Target = (CustomMessageBox)Sender;
			...
			if ( ContentBlock != null )
				...
				switch ( PI.DeviceInfos.Orientation )
					...
					case Infos.PhoneOrientation.LandscapeLeft :
						{
						ContentBlock.Margin = new Thickness 
						                       ( PI.DeviceInfos.ApplicationBarHeight, 24, 24, 24 );
						break;
						}
					case Infos.PhoneOrientation.LandscapeRight :
						{
						ContentBlock.Margin = new Thickness 
						                       ( 24, 24, PI.DeviceInfos.ApplicationBarHeight, 24 );
						break;
						}
		...
		public void Show()
			...
			if ( SystemTray.IsVisible )
				...
				//----------------------------------------------------------------------------------------------------------------
					...
					SystemTray.BackgroundColor = (Color)Application.Current.
					                                                  Resources["PhoneChromeColor"];
				//----------------------------------------------------------------------------------------------------------------
				}
			//--------------------------------------------------------------------------------------------------------------------
