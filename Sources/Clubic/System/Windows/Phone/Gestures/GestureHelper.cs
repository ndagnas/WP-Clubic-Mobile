		...
		public static GestureHelper Create ( UIElement Target )
			...
			Input.Touch.FrameReported += ( object S, Input.TouchFrameEventArgs A ) =>
				...
				try
					...
					//-----------------------------------------------------------------------------------------------------------
					FrameworkElement Parent = MainTouch.TouchDevice.DirectlyOver as 
					                                                              FrameworkElement;
				...
				//---------------------------------------------------------------------------------------------------------------
					...
					Helper.NotifyMove ( new ManipulationDeltaArgs ( Helper.Target, Origin, 
					                                                         Cumulative, Delta ) );
					//-----------------------------------------------------------------------------------------------------------
					}
				//---------------------------------------------------------------------------------------------------------------
					...
					Helper.NotifyUp   ( new ManiulationCompletedArgs ( Helper.Target, Origin, 
					                                                                     Total ) );
					//-----------------------------------------------------------------------------------------------------------
					}
				//---------------------------------------------------------------------------------------------------------------
